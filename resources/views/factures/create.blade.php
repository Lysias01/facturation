...
<div class="row justify-content-center">
    <div class="col-lg-10">
        <h1 class="h4 mb-3">Créer Pro-forma / Réçu</h1>
        ...
        <form action="{{ route('factures.store') }}" method="POST" class="card p-3 shadow-sm">
            @csrf
            ...
            <div class="mb-3">
                ...
                <select name="type_document" class="form-select" required>
                    <option value="pro-forma" {{ old('type_document')=='pro-forma'?'selected':'' }}>Pro-forma</option>
                    <option value="recu" {{ old('type_document')=='recu'?'selected':'' }}>Réçu</option>
                </select>
            </div>
